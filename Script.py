...
ʀᴇғᴇʀᴀʟ ʟɪɴᴋ - https://telegram.me/{}?start=NG-{}
...
ᴅɪᴅ ʏᴏᴜ ᴍᴇᴀɴ ᴀɴʏ ᴏɴᴇ ᴏꜰ ᴛʜᴇꜱᴇ?"""
    ...
    I_CUDNT = """<b>"https://graph.org/file/8f737d0dde9aa42dcf64d-4318b20a26b361261a.jpg"sᴏʀʀʏ ɴᴏ ꜰɪʟᴇs ᴡᴇʀᴇ ꜰᴏᴜɴᴅ ꜰᴏʀ ʏᴏᴜʀ ʀᴇǫᴜᴇꜱᴛ {} 😕
...
🚯 ᴅᴏɴᴛ ᴜꜱᴇ ➠ ':(!,./)"https://graph.org/file/8f737d0dde9aa42dcf64d-4318b20a26b361261a.jpg"</b>"""
...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    CAPTION = """<b> @nirmalgangadhar 📂 ғɪʟᴇɴᴀᴍᴇ : {file_name}
...
ஏய் <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 படி 1: இந்த @Prabhas_Movie_Filter_Bot போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்
...
Hey <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 Step 1: Administer this @Prabhas_Movie_Filter_Bot bot to your group
...
హే <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 దశ 1: ఈ @Prabhas_Movie_Filter_Bot బాట్‌ని మీ సమూహానికి నిర్వహించండి
...
अरे <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 चरण 1: इस @Prabhas_Movie_Filter_Bot बॉट को अपने समूह में प्रशासित करें
...
ഹേയ് <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ഘട്ടം 1: ഈ @Prabhas_Movie_Filter_Bot ബോട്ട് നിങ്ങളുടെ ഗ്രൂപ്പിലേക്ക് നൽകുക
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس @Prabhas_Movie_Filter_Bot بوٹ کا انتظام کریں۔
...
અરે <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ @Prabhas_Movie_Filter_Bot બોટનું સંચાલન કરો
...
ಹೇ {message.from_user.mention}
 ...
 ಹಂತ 1: ಈ @Prabhas_Movie_Filter_Bot ಬೋಟ್ ಅನ್ನು ನಿಮ್ಮ ಗುಂಪಿಗೆ ನಿರ್ವಹಿಸಿ
...
আরে <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই @Prabhas_Movie_Filter_Bot বট পরিচালনা করুন
